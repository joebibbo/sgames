...
genfixup.cpp   - builds to an executable. It will read file 'names' and create the final dataset 'names_'. This program was 
                 written because I used data set generator ( generatedata.com ) did not have a way to create dates with contraints. 
				 Consequently, the date that represented the death might have been before the birth date. This program santizes the dates, 
				 making sure everyone was born and died between 1900-2000, and that they died after they were born.
